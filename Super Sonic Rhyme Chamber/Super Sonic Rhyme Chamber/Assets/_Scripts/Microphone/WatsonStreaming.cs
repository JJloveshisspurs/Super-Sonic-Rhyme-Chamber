...
{
    public delegate void StopRecordingDel(string words);
    public event StopRecordingDel stopRecordEvent;
    ...
    public float lineDeliveryTime = 4f;
    ...
    private IEnumerator CreateService()
    {
        ...
        {
            Debug.Log("Setting service URL !!!!");

            _service.SetServiceUrl(_serviceUrl);
        }
        else
        {
            Debug.Log("Didn't set  service URL !!!!!");
    ...
    public bool Active
    {
        ...
        set
        {
            if (value && !_service.IsListening)
            {
                ...
                _service.InactivityTimeout = 1000;
        ...
        if (result != null && result.results.Length > 0)
        {
            foreach (var res in result.results)
            {
                foreach (var alt in res.alternatives)
                {
                    ...
                    if (stopRecordEvent != null && res.final)
                    {
